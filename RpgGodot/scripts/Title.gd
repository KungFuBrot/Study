...
const CREDIT_LINES := [
	...
	["\"Bosses and Monsters (Ars Notoria)\" by Stephen Challener", 14, "body"],
	["(Redshrike), CC-BY 3.0; shadow after Clint Bellanger and", 14, "body"],
	["horned mage after Ben Potter, both CC-BY-SA 3.0", 14, "body"],

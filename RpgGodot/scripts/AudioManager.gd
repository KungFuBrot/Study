...
const SONGS := {
	...
	"dungeon2": {"bpm": 76, "loop": true,
		...
		"drums": ""},
	# „Klingentanz" — a-Moll, treibende Achtel (Am-G-F-E-Pendel).
	"battle": {"bpm": 168, "loop": true,
		"mel": [[69, 0.5], [69, 0.5], [71, 0.5], [72, 0.5], [71, 0.5], [69, 0.5], [67, 1],
			[65, 0.5], [65, 0.5], [67, 0.5], [69, 0.5], [68, 1], [64, 1],
			[69, 0.5], [71, 0.5], [72, 0.5], [74, 0.5], [76, 0.5], [74, 0.5], [72, 0.5], [71, 0.5],
			[72, 0.5], [71, 0.5], [69, 0.5], [68, 0.5], [69, 1], [-1, 1],
			[76, 0.5], [76, 0.5], [74, 0.5], [72, 0.5], [74, 0.5], [72, 0.5], [71, 1],
			[72, 0.5], [74, 0.5], [76, 0.5], [77, 0.5], [76, 1], [74, 1],
			[77, 0.5], [76, 0.5], [74, 0.5], [72, 0.5], [71, 0.5], [72, 0.5], [74, 1],
			[69, 2], [68, 1], [64, 1]],
		"harm": [[57, 2], [55, 2], [53, 2], [52, 2]],

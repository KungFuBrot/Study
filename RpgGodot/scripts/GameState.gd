		...
		},
		{
			...
			"abilities": [
				...
				{"name": "Nuke", "cost": 14, "target": "all",
					...
					"desc": "Taktischer Sprengkopf — verwüstet das Schlachtfeld. (1x pro Kampf)"},

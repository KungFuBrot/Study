...
const F := {
	...
	"milo": {"class": HERO, "form": "human", "h": 1.66, "build": 0.95,
	...
	"rax": {"class": HERO, "form": "human", "h": 1.62, "build": 1.15, "head": 0.9,
		...
		"prop": "gun"},
	# --- Dorf ----------------------------------------------------------------
	"npc_elder": {"class": HERO, "form": "human", "h": 1.60, "build": 0.95,
	...
	"qualmgeist": {"class": MON, "form": "human", "h": 1.45, "build": 1.05,
	...
	"paragraphengeist": {"class": MON, "form": "human", "h": 1.50, "float": true,
	...
	"hassprediger": {"class": MON, "form": "human", "h": 1.62,
	...
	"grauschemen": {"class": MON, "form": "human", "h": 1.55, "float": true,
	...
	"boss2": {"class": BOSS, "form": "human", "h": 2.45, "build": 1.7, "head": 0.9,
	...
	"boss3": {"class": BOSS, "form": "human", "h": 2.70, "build": 1.5, "head": 0.9,
